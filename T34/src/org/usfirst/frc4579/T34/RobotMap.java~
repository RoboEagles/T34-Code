...
public class RobotMap {
    ...
    public static Accelerometer measurementrobotAccelerometer;
    ...
    */
	...
	LiveWindow.addSensor("measurement", "robotGyro", measurementrobotGyro);
        ...
        measurementrobotAccelerometer = new Accelerometer(1, 2);
	LiveWindow.addSensor("measurement", "robotAccelerometer", measurementrobotAccelerometer);
        measurementrobotAccelerometer.setSensitivity(1.0);
        measurementrobotAccelerometer.setZero(2.5);

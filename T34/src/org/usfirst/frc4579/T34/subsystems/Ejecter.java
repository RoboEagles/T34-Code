 ...
 *
 */
public class Ejecter extends Subsystem {
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    Solenoid ejectSolenoid = RobotMap.ejecterEjectSolenoid;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    private double ejectTime = 1.0;
    ...
    public void setEjectTime(double ejectTime) {

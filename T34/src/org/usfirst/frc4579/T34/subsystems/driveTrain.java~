...
public class driveTrain extends Subsystem {
    ...
    Gyro robotGyro = RobotMap.driveTrainrobotGyro;
    Accelerometer robotAccelerometer = RobotMap.driveTrainrobotAccelerometer;
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    
    public void drive(double x, double y, double z) {
        driveBase.mecanumDrive_Cartesian(x, y, z, robotGyro.getAngle());
    }

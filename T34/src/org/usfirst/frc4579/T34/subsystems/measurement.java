...
public class measurement extends Subsystem {
    ...
    private void measureRaw() {
        ...
        accelVector.X = robotPrimaryAccelerometer.getAcceleration(ADXL345_I2C.Axes.kX);
        accelVector.Y = robotPrimaryAccelerometer.getAcceleration(ADXL345_I2C.Axes.kY);
        accelVector.Z = robotPrimaryAccelerometer.getAcceleration(ADXL345_I2C.Axes.kZ);
